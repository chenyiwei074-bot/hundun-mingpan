  ...
  return (
    <div className="min-h-screen bg-bg-primary">
      ...
      <nav className="fixed top-0 z-50 w-full" style={{
        background: 'rgba(250,250,249,0.85)', backdropFilter: 'blur(20px) saturate(180%)',
        WebkitBackdropFilter: 'blur(20px) saturate(180%)', borderBottom: '0.5px solid rgba(0,0,0,0.08)',
      }}>
        <div className="mx-auto flex h-11 max-w-[1024px] items-center justify-between px-6">
          ...
          <div className="flex sm:hidden items-center gap-4 text-xs">
            <a href="/create" className="no-underline" style={{ color: '#1d1d1f' }}>命盘</a>
            <a href="/liuyao" className="no-underline" style={{ color: '#1d1d1f' }}>六爻</a>
          </div>
        </div>
      </nav>
